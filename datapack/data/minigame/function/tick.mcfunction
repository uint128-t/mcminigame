...
execute at @e[type=spectral_arrow,nbt={inGround:1b}] run summon creeper ~ ~ ~ {Fuse:0,ExplosionRadius:5,CustomName:"RPG",Invulnerable:1b}
execute at @e[type=spectral_arrow,nbt={inGround:1b}] run particle explosion ~ ~ ~ 0.5 0.5 0.5 3 20 force
execute at @e[nbt={active_effects:[{id:"minecraft:glowing",duration:199}]}] run summon creeper ~ ~ ~ {Fuse:0,ExplosionRadius:5,CustomName:"RPG",Invulnerable:1b}
